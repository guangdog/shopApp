...
import homemenu from './homepage/homemenu.vue'
import recommendcol2 from './homepage/recommendcol2.vue'
import recommendcol3 from './homepage/recommendcol3.vue'
import recommendcol1 from './homepage/recommendcol1.vue'
export default {
  data () {
    return {
      dataObj: {
